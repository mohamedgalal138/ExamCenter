namespace ExamCenter.Pages.Admin
{
    partial class AddNewEX
    {
        ...
        private void InitializeComponent()
        {
            ...
            butAddQueAns = new Button();
            butAddAnswer = new Button();
            ...
            // butSave
            // 
            butSave.FlatAppearance.BorderSize = 0;
            butSave.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
            butSave.Location = new Point(961, 147);
            butSave.Name = "butSave";
            butSave.Size = new Size(112, 40);
            butSave.TabIndex = 3;
            butSave.Text = "Save";
            butSave.UseVisualStyleBackColor = true;
            butSave.UseWaitCursor = true;
            ...
            panelExamQuestionForm.Controls.Add(butAddQueAns);
            panelExamQuestionForm.Controls.Add(butAddAnswer);
            ...
            // butAddQueAns
            // 
            butAddQueAns.Location = new Point(1012, 591);
            butAddQueAns.Name = "butAddQueAns";
            butAddQueAns.Size = new Size(112, 40);
            butAddQueAns.TabIndex = 10;
            butAddQueAns.Text = "Save";
            butAddQueAns.UseVisualStyleBackColor = true;
            butAddQueAns.Click += butAddQueAns_Click;
            // 
            // butAddAnswer
            // 
            butAddAnswer.Location = new Point(833, 302);
            butAddAnswer.Name = "butAddAnswer";
            butAddAnswer.Size = new Size(170, 40);
            butAddAnswer.TabIndex = 9;
            butAddAnswer.Text = "Add Choice";
            butAddAnswer.UseVisualStyleBackColor = true;
            butAddAnswer.Visible = false;
            butAddAnswer.Click += butAddAnswer_Click;
            // 
            // AddNewEX
            // 
        ...
        private Button butAddQueAns;
        private Button butAddAnswer;
